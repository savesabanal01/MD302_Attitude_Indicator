...
void MFCustomDevice::attach(uint16_t adrPin, uint16_t adrType, uint16_t adrConfig)
{
    ...
    ********************************************************************************** */
    ...
    if (strcmp(parameter, "MD302_Attitude_Indicator") == 0)
    ...
    if (_customType == MY_CUSTOM_DEVICE_1) {
        ...
        ********************************************************************************** */
        if (!FitInMemory(sizeof(MD302_Attitude_Indicator))) {
        ...
        ********************************************************************************** */
        ...
        _mydevice = new (allocateMemory(sizeof(MD302_Attitude_Indicator))) MD302_Attitude_Indicator();
        _mydevice->attach();
